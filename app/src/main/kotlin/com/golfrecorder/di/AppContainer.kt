...
import com.golfrecorder.BuildConfig
import com.golfrecorder.data.local.AppDatabase
import com.golfrecorder.data.remote.NetworkModule
...
/**
 * 수동으로 짜는 최소 DI 컨테이너. 의존성이 DB와 리포지토리 몇 개뿐이라
...
class AppContainer(context: Context) {
    ...
    val courseYoutubeLinkRepository: CourseYoutubeLinkRepository = CourseYoutubeLinkRepository(
        database.courseYoutubeLinkDao(),
        NetworkModule.createOembedApi(),
        NetworkModule.createYoutubeSearchApi(),
